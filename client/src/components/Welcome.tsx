...
const Welcome = () => {
    ...
    return (
        <div className="flex w-full justify-center items-center">
            <div className="flex mf:flex-row flex-col items-start justify-between mf-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col mr-10">
                    <h1 className="text-3xl sm:text-5xl  text-white text-gradient py-1">
                        Send Crypto <br /> across the world
                    </h1>
                    <p className="text-elft mt-5 text-white font-white md:w-9/12 w-11/12 text-base">Explore crypto around the world. Buy and cell crypto across the world!</p>
